 ...
 * file exists only where the set has no equivalent at all.
 */
 ...
 * `ArrowLeft02Icon`, whose shaft spans 13.5 of the 24-unit viewBox; the rest are
 * shorter, bare chevrons, or arrows into a vertical bar. The SDK's back control
 * drew Lucide's `MoveLeft` before the icon migration, whose shaft is 20 units,
 * so moving to the set visibly shortened it.
 *
