import type { SessionStatus, VerificationStatusResponse } from '../services/api';
...
// mobile SDKs' twin (RN lib/result-wait.ts, Flutter config/result_wait.dart):
// the screen owns nothing but the rendering. Keep the three in lockstep.
