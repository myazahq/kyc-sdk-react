...
// wrong way round for a field labelled "Website".
//
// So: an optional http(s) scheme, a hostname with at least one dot and a
// plausible TLD, and whatever path the company wants to include. Anything
// beyond that (does it resolve? does it serve a page?) is not something a form
// can answer, and pretending otherwise would just block valid addresses.
